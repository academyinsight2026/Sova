        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
          <div className="flex flex-col lg:flex-row items-center gap-10">
            ...
            <div className="shrink-0">
              <div className="w-52 sm:w-64 shadow-2xl rounded-lg overflow-hidden border border-border">
                <Image
                  src="/sova-cover.jpg"
                  alt="Обложка журнала SOVA"
                  width={256}
                  height={360}
          ...
          <>
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
              ...
              <div className="flex items-center gap-3">
                <div className="w-12 h-16 rounded overflow-hidden border border-border shadow-sm shrink-0">
                  <Image
                    src="/sova-cover.jpg"
                    alt="Обложка выпуска"
                    width={48}
