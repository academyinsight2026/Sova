                  ...
                  return (
                    <div key={i} className="flex gap-5 items-start">
                      ...
                      <div className="sova-card p-5 flex-1">
                        ...
                        {i === 1 && (step as { templateLink?: string }).templateLink && (
                          <a
                            href={(step as { templateLink?: string }).templateLink}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-1.5 mt-2 text-sm font-medium text-[#1a56db] hover:underline"
                          >
